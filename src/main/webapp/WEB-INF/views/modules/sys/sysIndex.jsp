	...
	<div id="main">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2015-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} ${fns:getConfig('version')}- Powered By <a href="${fns:getConfig('authorUrl')}" target="_blank">${fns:getConfig('author')}</a>
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
